...
const recordNewCaseFileAssignment = (req, res, next) =>
  getCaseFileDetails(req.params.oid)
    ...
    .then(redirect(res, req.baseUrl + '/' + req.params.oid));

// middleware

const setup = (req, res, next) =>
  (router.caseFile = router.caseFile || CaseFileServiceConnection) && next();
...
router.post('/:oid/assign', recordNewCaseFileAssignment);
